...
- CRITICAL: Prisma is imported into a file that has `export const runtime = 'edge'`. Per `CLAUDE.md`, Prisma is Node.js only. Move the route to Node.js runtime OR rewrite the query using the Supabase JS client at `@/lib/supabase`.
